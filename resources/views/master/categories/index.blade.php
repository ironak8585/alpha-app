        ...
        <div class="container">
            <nav class="level">
                ...
                <div class="level-right">
                    <div class="buttons">
                        <a class="button is-info is-outlined" href="{{ route('master.categories.create') }}">
                            <span class="icon">
                                <i class="fas fa-plus"></i>
                            </span>
                            <span>Create New</span>
                        </a>
                        <x-filter-panel :fields="$fields" :filters="$filters" route="master.categories">
                        </x-filter-panel>
                    </div>
                </div>
            </nav>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="field buttons are-small is-grouped is-grouped-right">
                                            <x-default-action route-prefix="master.categories" :id="$record->id"
                                                :show="true">
                                            </x-default-action>
                                        </div>
                                    </td>
