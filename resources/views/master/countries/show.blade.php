            ...
            <nav class="level">
                ...
                <div class="level-right">
                    <div class="field is-grouped">
                        <p class="control">
                            <a class="button is-info" href="{{ route('master.countries.edit', $country->id) }}">
                ...
                <div class="box">
                        ...
                        <div class="level-right">
                            <div class="level-item">
                                <div class="tags has-addons is-right">
                                    ...
                                    <span class="tag is-large is-danger">{{ $country->country }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="columns">
                        <div class="column is-3">
                            <x-info label="Type" :value="$country->type" icon="<i class='fas fa-at'></i>"></x-info>
                        </div>
                        <div class="column is-3">
                            <x-info label="Value" :value="$country->value"></x-info>
                        </div>
                    </div>
                    <x-timestamps :record="$country"></x-timestamps>
                </div>
            </article>
        </div>
    </x-slot>
